...
First, load the `rsconnect` package and set the account name, token, and secret, which can be found on the Profile / Tokens page of your [https://www.shinyapps.io] account.
